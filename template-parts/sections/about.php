...
<div id="about" class="wp-block-group alignwide terminal-panel terminal-about terminal-section">
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center terminal-about-copy">
			<?php if ( ! empty( $label ) ) : ?>
				<p class="terminal-label"><?php echo esc_html( $label ); ?></p>
			<?php endif; ?>

			<h2 class="wp-block-heading section-title"><?php echo nl2br( esc_html( $heading ) ); ?><span class="terminal-title-cursor" aria-hidden="true">_</span></h2>
					...
					<?php foreach ( $stats as $stat ) : ?>
						<p>
							<b>
								...
								echo geekypress_get_icon( $stat_icon, 'stat-icon', 28 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
								?>
