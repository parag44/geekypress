			...
			<h2 class="comments-title section-title">
				...
				if ( '1' === $geekypress_comment_count ) {
					$comments_heading = sprintf(
						/* translators: 1: title. */
						__( '01_comment on &ldquo;%1$s&rdquo;', 'geekypress' ),
						'<span>' . wp_kses_post( get_the_title() ) . '</span>'
					);
				} else {
					$comments_heading = sprintf(
						/* translators: 1: comment count number, 2: title. */
						_nx( '%1$s_comment on &ldquo;%2$s&rdquo;', '%1$s_comments on &ldquo;%2$s&rdquo;', $geekypress_comment_count, 'comments title', 'geekypress' ),
