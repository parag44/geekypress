...
// Enable Slider / Carousel Mode
$wp_customize->add_setting(
	'geekypress_blog_slider_enabled',
	array(
		'default'           => true,
		'transport'         => 'refresh',
		'sanitize_callback' => 'geekypress_sanitize_checkbox',
...
$wp_customize->add_control(
	'geekypress_blog_slider_enabled',
	array(
		'label'       => __( 'Enable Slider / Carousel Mode (Experimental)', 'geekypress' ),
		'description' => __( 'Display articles in an interactive sliding carousel with top-right < and > navigation controls.', 'geekypress' ),
		'section'     => 'geekypress_blog_section',
		'type'        => 'checkbox',
	)
);

// Articles Per Screen (Desktop)
$wp_customize->add_setting(
	'geekypress_blog_per_screen',
	array(
		'default'           => 3,
		'transport'         => 'refresh',
...
$wp_customize->add_control(
	'geekypress_blog_per_screen',
	array(
		'label'       => __( 'Articles Per Screen', 'geekypress' ),
		'description' => __( 'Choose how many articles are visible at once in the carousel on desktop (1-4).', 'geekypress' ),
		'section'     => 'geekypress_blog_section',
		'type'        => 'number',
		'input_attrs' => array(
			'min'  => 1,
...
$wp_customize->add_control(
	'geekypress_blog_count',
	array(
		'label'       => __( 'Total Articles to Query', 'geekypress' ),
		'description' => __( 'Choose total number of recent articles to query for sliding or display (1-18).', 'geekypress' ),
		'section'     => 'geekypress_blog_section',
		'type'        => 'number',
		'input_attrs' => array(
			'min'  => 1,
